...
(function($){
	...
	ATBS.documentOnReady = {
		...
		init: function(){
			...
			ATBS.documentOnReady.carousel_1i_not_auto_height();
			ATBS.documentOnReady.carousel_1i_dot_number();
			ATBS.documentOnReady.carousel_1i_dot_number_2();
			ATBS.documentOnReady.carousel_1i_loopdot();
			ATBS.documentOnReady.carousel_1i0dot();
			...
			ATBS.documentOnReady.carousel_3i_center();
		...
		carousel_1i_not_auto_height: function() {
			var $carousels = $('.js-mnmd-carousel-1i-not-auto-height');
			$carousels.each( function() {
				$(this).owlCarousel({
					items: 1,
					margin: 0,
		...
		carousel_1i_dot_number: function() {
			var $carousels = $('.js-mnmd-carousel-1i-dot-number');
			$carousels.each( function() {
				$(this).owlCarousel({
					items: 1,
					margin: 0,
		...
		carousel_1i_dot_number_2: function() {
			var $carousels = $('.js-mnmd-carousel-1i-dot-number-2');
			$carousels.each( function() {
				$(this).owlCarousel({
					items: 1,
					margin: 0,
		...
		carousel_1i_loopdot: function() {
			var $carousels = $('.js-mnmd-carousel-1i-loopdot');
			$carousels.each( function() {
				$(this).owlCarousel({
					items: 1,
					margin: 0,
		...
		carousel_1i0dot: function() {
			var $carousels = $('.js-mnmd-carousel-1i0dot');
			$carousels.each( function() {
				$(this).owlCarousel({
					items: 1,
					margin: 0,
		...
		carousel_3i_center: function() {
			var $carousels = $('.carousel_3i_center');
			$carousels.each( function() {
				$(this).owlCarousel({
					dots: true,
					// loop:true,
